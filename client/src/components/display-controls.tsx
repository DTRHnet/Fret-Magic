        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-2">
            <Button variant="ghost" className="w-full justify-start h-auto p-3">
              <span className="text-left text-sm">Save Preset</span>
            </Button>
            <Button variant="ghost" className="w-full justify-start h-auto p-3">
              <span className="text-left text-sm">Export as Image</span>
            </Button>
            <Button variant="ghost" className="w-full justify-start h-auto p-3">
              <span className="text-left text-sm">Clear Fretboard</span>
            </Button>
          </div>
        </CardContent>
      </Card>
